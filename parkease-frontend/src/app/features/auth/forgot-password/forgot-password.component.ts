...
@Component({
  ...
  styles: [`
    ...
    .success-state { text-align: center; .success-icon { width: 64px; height: 64px; background: hsla(var(--p-success), 0.1); color: var(--success); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto; svg { width: 32px; height: 32px; } } h3 { font-size: 1.5rem; color: #fff; } p { color: var(--text-muted); } }
