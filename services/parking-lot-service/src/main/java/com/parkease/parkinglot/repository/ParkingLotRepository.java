...
public interface ParkingLotRepository extends JpaRepository<ParkingLot, UUID> {
    ...
    /**
     * Find all approved (and optionally open) lots in a given city.
     */
    ...
    /**
     * Find all open and approved lots (available for booking).
     */
    List<ParkingLot> findByIsOpenTrueAndIsApprovedTrue();

    /**
     * Geo-proximity search: find approved lots within a bounding box
     * approximated from the given latitude/longitude and a radius (km).
     *
     * <p>Uses the Haversine formula expressed in JPQL to compute
    ...
    /**
     * Delete all lots managed by a given manager.
     */
